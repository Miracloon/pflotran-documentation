# -*- coding: utf-8 -*-
#
# PFLOTRAN documentation build configuration file, created by
...
import os
import sys
sys.path.insert(0, os.path.abspath('../qa_tests'))
...
html_title = u'PFLOTRAN Documentation'
...
htmlhelp_basename = 'PFLOTRANdocs'
...
man_pages = [
    (master_doc, 'pflotran_doc', u'PFLOTRAN Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pflotran_doc', u'PFLOTRAN Documentation',
     author, 'PFLOTRAN Documentation', 'One line description of project.',
     'Miscellaneous'),
]
